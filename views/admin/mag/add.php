<?php
$pageTitle = 'Add MAG Device';
ob_start();
?>
<div class="mb-4"><h1 class="text-xl font-bold text-white">Add MAG Device</h1></div>
<div class="glass rounded-xl border border-gray-800/50 p-6 max-w-2xl">
    <form method="POST">
        ...
        <div class="flex gap-2">
            ...
            <a href="<?= ADMIN_PATH ?>/mag" class="px-4 py-2 rounded bg-gray-700 text-gray-300 text-xs">Cancel</a>
        </div>
    </form>
</div>
